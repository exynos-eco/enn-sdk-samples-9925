...
### NNC Model Tester
The "NNC Model Test" sample program illustrates executing an NNC model using the ENN Framework.
...
For more information, including specific instructions and parameters, refer to the [README](https://github.com/exynos-eco/enn-sdk-samples-9925/tree/main/nnc-model-tester#readme) file in the [Github](https://github.com/exynos-eco/enn-sdk-samples-9925) repository.
